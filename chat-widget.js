...
(function() {
    ...
    const defaultSettings = {
        ...
        branding: {
            ...
            responseTimeText: '',
            poweredBy: {
                text: 'Powered by Magic360™',
                link: 'https://magic360.xyz'
            }
        },
        style: {
    ...
    const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" placeholder="Intreaba orice despre platforma" rows="1"></textarea>
    ...
    launchButton.innerHTML = `
        ...
        <!-- <span class="chat-launcher-text">Need help?</span> -->`; // Linia ignorată: textul nu va mai apărea pe butonul de lansare al chatului
    ...
    async function skipRegistrationAndStartChat() {
        ...
        try {
            ...
            errorMessage.textContent = "Bună! Sunt asistentul tau AI Promovista, cu ce te pot ajuta?";
